-- Cloe Dashboard v0.1 — declarative schema proposal.
-- This file has not been applied to a remote database.
...
revoke all on table public.assets, public.candles, public.technical_analyses, public.macro_observations,
  public.fundamental_analyses, public.market_events, public.news_items, public.daily_syntheses from anon;
